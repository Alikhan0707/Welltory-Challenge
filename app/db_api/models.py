...
class UserData(peewee.Model):
    user_id = peewee.ForeignKeyField(User, backref='userdatas', on_delete='CASCADE')
...
class Correlation(peewee.Model):
    user_data_id = peewee.ForeignKeyField(UserData, backref='correlations', on_delete='CASCADE')
